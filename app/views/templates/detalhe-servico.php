...
<section class="kiServico-detalhe">
    <div class="site">
        <div class="kiServicoDetalhe-header">
            <h1>Serviços</h1>
            <div class="kiServico-Detalhe-subtitulo">
                <p>Home/</p>
                <p>Serviços</p>
            </div>
            <div class="kiServicos-Detalhe-border"></div>
        </div>
        <div class="kiServico-detalhe-conteiner">
            <div class="of-height-60"></div>
            <div class="kiServico-detalhe-conteudo">
                <div class="of-height-50"></div>
                <div class="kiServico-conteudo-header">
                    <h2>AutoCare Solutions - Tire Services</h2>
                    <p>At AutoCare Solutions, we understand that your tires are a critical component of your vehicle's performance, safety, and overall driving experience. Our tire services are designed to ensure that your tires are in optimal condition, providing you with the traction, handling, and comfort you deserve. Explore our comprehensive tire services below:</p>

                    <img src="../../../public/assets/img/services-single.jpg" alt="">
                </div>
                <div class="of-height-50"></div>
                <div class="kiServico-conteudo-texto">
                    <div class="kiServico-detalhe-desc">
                        <h3>1. TIRE ROTATION:</h3>
                        <p>Regular tire rotation is essential for even tread wear and longevity. Our technicians will rotate your tires according to your vehicle's specifications, promoting balanced wear patterns and extending the life of your tires.</p>
                    </div>
                    <div class="kiServico-detalhe-desc">
                        <h3>2. Tire Balancing:</h3>
                    ...
                    <div class="kiServico-detalhe-desc">
                        <h3>3. Wheel Alignment:</h3>
                        <p>Proper wheel alignment is crucial for maintaining vehicle stability and preventing uneven
                            tire
                            wear. Our advanced alignment equipment and skilled technicians will ensure that your wheels
                            are
                            aligned to manufacturer specifications.</p>

                        <div class="kiservico-detalhe-imagem-aside">
                            <img src="../../../public/assets/img/services-single-2.jpg" alt="">
                            <img src="../../../public/assets/img/services-single-3.jpg" alt="">
                        </div>
                    </div>
                    <div class="of-height-50"></div>
                    <div class="kiServico-detalhe-desc">
                        <h3>4. Tire Repair:</h3>
                        <p>If you've experienced a flat tire or puncture, our tire repair services are here to help.
                            We'll
            ...
            <div class="kiServico-container-aside">
                <div class="of-height-50"></div>
                <div class="kiServico-box">
                    ...
                    <div class="kiServico-desc">
                        <a href="#" class="title">Brake System Repair</a>
